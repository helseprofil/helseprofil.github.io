...
+===========================================================================+==================================================================================================================+===========================================================================+
| Ferdig kubedatafil til statistikkbanken (\"kube\", output fra R-systemet) | Defineres i tabell KUBER -- KUBE\_NAVN.                                                                          | Bygger på en TNP-fil, angitt i KUBER -- TNP.                              |
+---------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| TNP-fil                                                                   | Defineres i tabell TNP\_PROD -- TNP\_NAVN.                                                                       | Bygger på en tellerfil, angitt i TNP\_PROD -- TELLERFIL,                  |
|                                                                           |                                                                                                                  |                                                                           |
|                                                                           |                                                                                                                  | og evt. en nevnerfil angitt i                                             |
|                                                                           |                                                                                                                  |                                                                           |
|                                                                           |                                                                                                                  | -- NEVNERFIL.                                                             |
+---------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| Tellerfilen =en filgruppe                                                 | Defineres normalt i tabell FILGRUPPER -- FILGRUPPE, som regel i skjemaet STYRING\\StyrFILGRUPPER øverste tabell. | Bygger på én eller flere inndatafiler (ORGfiler), som angis i -- FILNAVN. |
|                                                                           |                                                                                                                  |                                                                           |
|                                                                           | (Kan evt. defineres i FILFILTRE, dvs. lages runtime. Det er mer aktuelt for nevnerfilen.)                        | Disse har hver sin IBrukFra og IBrukTil-dato.                             |
+---------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+
